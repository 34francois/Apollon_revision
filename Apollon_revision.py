        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              ...
              {f"<img src='data:image/jpeg;base64,{current_image_question}' style='max-width: 100%; max-height: 100%;' />" if current_image_question and current_image_question.strip() and 'data:image' in current_image_question else ""}
            </div>
            <div class="flip-card-back">
              <p>{current_answer}</p>
              {f"<img src='data:image/jpeg;base64,{current_image_reponse}' style='max-width: 100%; max-height: 100%;' />" if current_image_reponse and current_image_reponse.strip() and 'data:image' in current_image_reponse else ""}
            </div>
          </div>
        </div>
        """
